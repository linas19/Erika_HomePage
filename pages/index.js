      ...
      <body>
        ...
        <div className={styles.secondPage}>
          <div className={styles.threePoints}>
            ...
            <div className={styles.technology}> 
              <div className={styles.technologyText}>Technology</div>
              <div>Building an app that is both stable and scalable is not easy but I have been fortunate to have worked with some of the latest Javascript technologies on a variety of problems. I adapt my approach to meet the specific needs of your team and product.</div>
            </div>
          ...
          <div>
            ...
            <div className={styles.secondImage}>
              <img  src='public\secondImage.JPG'/>
            </div>
          </div>
        </div>
        <div className={styles.thirdPage}>
          ...
          <div className={styles.thirdPageBottom}>
            ...
            <div>Alex Brown, Senior Product Manager at Eurosport</div>
          </div>
        </div>
        <div className={styles.thirdPage}>
